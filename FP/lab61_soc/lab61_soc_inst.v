	lab61_soc u0 (
		.a_loc_export                   (<connected-to-a_loc_export>),                   //                   a_loc.export
		...
		.x_key_export                   (<connected-to-x_key_export>),                   //                   x_key.export
		.y_key_export                   (<connected-to-y_key_export>)                    //                   y_key.export
	);
